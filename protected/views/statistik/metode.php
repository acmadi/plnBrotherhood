...
<div id="sidebar">
	...
	<ul>
		...
		<li class="onprogress"><?php echo CHtml::link('Pengadaan per metode pengadaan', array('statistik/metode', 'chart'=>'1')) ?></li>
	</ul>
	<?php $this->endWidget(); ?>
</div>
...
<div id="maincontent">
	<div id="menuform">
		<?php $this->widget('zii.widgets.CMenu', array(
			'items'=>array(
				array('label'=>'Berlangsung', 'url'=>array('statistik/metode', 'chart'=>'1')),
				array('label'=>'Selesai', 'url'=>array('statistik/metode', 'chart'=>'2')),
				array('label'=>'Gagal', 'url'=>array('statistik/metode', 'chart'=>'3')),
				array('label'=>'Total', 'url'=>array('statistik/metode', 'chart'=>'4')),
			),
		));
		?>
	</div>
	...
	<?php $this->widget('HighchartsWidget', array(
			'options'=>array(
				...
				'subtitle'=>array('text'=>'per metode pengadaan'),
				'plotOptions'=>array(
					'pie'=>array(
						'dataLabels'=>array(
						...
						'events'=>array(
							'click'=>'js:function(event) {window.location="' . Yii::app()->createUrl('statistik/metode') . '&chart=' . $chart . '&detail=' . '" + event.point.name;}',
						),
					),
				),
				'series'=>array(

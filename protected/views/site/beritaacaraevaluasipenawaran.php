...
<div id="pagecontent">
	...
	<?php } else { ?>
		<div>
		<?php echo CHtml::button('Berita Acara Pembukaan Penawaran', array('submit'=>array('site/editberitaacarapembukaanpenawaran',"id"=>"$cpengadaan->id_pengadaan"), 'style'=>'background:url(css/bg.gif)')); ?>
		</div>
		<br/>
	<?php } ?>

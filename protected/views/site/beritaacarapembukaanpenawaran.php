...
<div id="pagecontent">
	...
	<?php } else { ?>
		<div>
			...
			<?php } else { ?>
				<?php echo CHtml::button('Berita Acara Evaluasi Penawaran', array('submit'=>array('site/editberitaacaraevaluasipenawaran',"id"=>"$cpengadaan->id_pengadaan"), 'style'=>'background:url(css/bg.gif)')); ?>
			<?php } ?>
		</div>
		<br/>
	<?php } ?>

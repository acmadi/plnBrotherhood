                ...
                <div id="menuform">
                    <?php
                        $this->widget('zii.widgets.CMenu', array(
                            'items'=>array(
                                    array('label'=>'BA Evaluasi Tahap Dua', 'url'=>array(Pengadaan::model()->findByPk($id)->status=='13'?'/site/beritaacaraevaluasipenawarantahap2':'/site/editberitaacaraevaluasipenawarantahap2','id'=>$id)),                                    
                            ),
                        ));
                    ?>
                </div>

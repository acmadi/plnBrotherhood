...
<div id="pagecontent">
	...
	<div id="maincontent">
		...
		<?php $Dokumenx->id_pengadaan=$id;?>
		
		<div class="row" style = "display:none">
		<?php echo $form->labelEx($Dokumenx,'nama pengadaan'); ?>
		<?php echo $form->textField($Dokumenx,'id_pengadaan'); ?>
		<?php echo $form->error($Dokumenx,'id_pengadaan'); ?>
		</div>

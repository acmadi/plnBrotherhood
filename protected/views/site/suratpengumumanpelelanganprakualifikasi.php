			...
			<div id="menuform">
				...
				$this->widget('zii.widgets.CMenu', array(
						'items'=>array(
							...
							array('label'=>'Pengambilan Dokumen', 'url'=>array($Pengadaan->status=='7'?('/site/pengambilandokumenkualifikasi'):($Pengadaan->status=='6'?'':($Pengadaan->status=='6'?'':('/site/editpengambilandokumenkualifikasi'))),'id'=>$id)),
						),
					));
				?>
			</div>

			...
			<div id="menuform">
				...
				$this->widget('zii.widgets.CMenu', array(
						'items'=>array(
							...
							array('label'=>'Pengambilan Dokumen', 'url'=>array($Pengadaan->status=='8'?('/generator/pengambilandokumenprakualifikasi'):('/generator/editpengambilandokumenprakualifikasi'),'id'=>$id)),
						),
					));
				?>
			</div>

                    ...
                    <?php
                        $this->widget('zii.widgets.CMenu', array(
                            'items'=>array(
                                    ...
                                    array('label'=>'SP Pemenang', 'url'=>array($SPP->isNewRecord?'/generator/suratpengumumanpemenang':'/generator/editsuratpengumumanpemenang','id'=>$id)),
                                    array('label'=>'Surat Penunjukan Pemenang', 'url'=>array(Pengadaan::model()->findByPk($id)->status=='36'?'/generator/suratpenunjukanpemenang':(Pengadaan::model()->findByPk($id)->status=='35'?'':'/generator/editsuratpenunjukanpemenang'),'id'=>$id)),
                            ),
                        ));
                    ?>
                </div>

                    ...
                    <?php
                        $this->widget('zii.widgets.CMenu', array(
                            'items'=>array(
                                    ...
                                    array('label'=>'ND Pemberitahuan', 'url'=>array($NDBP->isNewRecord?'/generator/notadinaspemberitahuanpemenang':'/generator/editnotadinaspemberitahuanpemenang','id'=>$id)),
                                    array('label'=>'Surat Penunjukan Pemenang', 'url'=>array(Pengadaan::model()->findByPk($id)->status=='36'?'/generator/suratpenunjukanpemenang':(Pengadaan::model()->findByPk($id)->status=='34'?'':'/generator/editsuratpenunjukanpemenang'),'id'=>$id)),
                            ),
                        ));
                    ?>
                </div>

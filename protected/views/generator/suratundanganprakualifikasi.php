			...
			<div id="menuform">
              	<?php
						$this->widget('zii.widgets.CMenu', array(
							'items'=>array(
								array('label'=>'Undangan PQ', 'url'=>array($SUPK->isNewRecord?'/generator/suratundanganprakualifikasi':'/generator/editsuratundanganprakualifikasi','id'=>$id)),
							),
						));
					?>
            </div>

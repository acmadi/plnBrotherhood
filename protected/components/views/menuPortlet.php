	...
	<?php if(Anggota::model()->exists('username = "' . Yii::app()->user->name . '"')){ ?>
		...
		<?php if ($cpengadaan->jenis_kualifikasi=="Pra Kualifikasi") { ?>
			...
			<?php } else if($cpengadaan->status == '1') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 1',array("site/dokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '2') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 1',array("site/suratundanganprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '3') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 1',array("site/pengumumanpelelanganprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '4') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 1',array("site/pendaftaranpelelanganprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '5') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 1',array("site/pengambilandokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
			...
			<?php } else if($cpengadaan->status == '6') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 2',array("site/penyampaiandokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '7') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 2',array("site/evaluasiprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '8') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 2',array("site/penetapanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '9') { ?>
					<li class='sudah' ><?php echo CHtml::link('Prakualifikasi Bagian 2',array("site/pengumumanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
		...
		<?php if($cpengadaan->status == '0'||$cpengadaan->status == '1'||$cpengadaan->status == '2'||$cpengadaan->status == '3'||$cpengadaan->status == '4'||$cpengadaan->status == '5'||$cpengadaan->status == '6'||$cpengadaan->status == '7'||$cpengadaan->status == '8'||$cpengadaan->status == '9'||$cpengadaan->status == '10'||$cpengadaan->status == '11'||$cpengadaan->status == '12'||$cpengadaan->status == '13'||$cpengadaan->status == '14'||$cpengadaan->status == '15'||$cpengadaan->status == '16'||$cpengadaan->status == '17'||$cpengadaan->status == '18'||$cpengadaan->status == '19'||$cpengadaan->status == '20'||$cpengadaan->status == '21') { ?>
			...
			<?php } else if($cpengadaan->status == '25') { ?>
				<li class='sudah'><?php echo CHtml::link('Penentuan Pemenang',array("site/suratpengumumanpelelangan","id"=>"$cpengadaan->id_pengadaan")); ?></li>

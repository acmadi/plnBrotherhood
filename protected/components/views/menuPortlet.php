	...
	<?php if(Anggota::model()->exists('username = "' . Yii::app()->user->name . '"')){ ?>
		...
		<?php if ($cpengadaan->jenis_kualifikasi=="Pra Kualifikasi") { ?>
			...
			<?php } else if($cpengadaan->status == '9') { ?>
				<li class='sudah' ><?php echo CHtml::link('Penyampaian dan Evaluasi Kualifikasi',array("site/evaluasidokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
				<li class='sudah' ><?php echo CHtml::link('Penyampaian dan Evaluasi Kualifikasi',array("site/editevaluasidokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } ?>
			...
			<?php } else if($cpengadaan->status == '10') { ?>
				<li class='sudah' ><?php echo CHtml::link('Usulan dan Penetapan Hasil Kualifikasi',array("site/usulanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			...
			<?php } else { ?>
				<li class='sudah' > <?php echo CHtml::link('Usulan dan Penetapan Hasil Kualifikasi',array("site/editpenetapanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } ?>
		...
		<?php if($cpengadaan->status == '0'||$cpengadaan->status == '1'||$cpengadaan->status == '2'||$cpengadaan->status == '3'||$cpengadaan->status == '4'||$cpengadaan->status == '5'||$cpengadaan->status == '6'||$cpengadaan->status == '7'||$cpengadaan->status == '8'||$cpengadaan->status == '9'||$cpengadaan->status == '10'||$cpengadaan->status == '11'||$cpengadaan->status == '12'||$cpengadaan->status == '13'||$cpengadaan->status == '14'||$cpengadaan->status == '15'||$cpengadaan->status == '16'||$cpengadaan->status == '17'||$cpengadaan->status == '18'||$cpengadaan->status == '19'||$cpengadaan->status == '20'||$cpengadaan->status == '21') { ?>
			...
			<?php } else if($cpengadaan->status == '22') { ?>
				<li class='sudah'><?php echo CHtml::link('Klarifikasi dan Negosiasi',array("site/beritaacaranegosiasiklarifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
				<li class='sudah'><?php echo CHtml::link('Klarifikasi dan Negosiasi',array("site/editberitaacaranegosiasiklarifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
		<?php } ?>

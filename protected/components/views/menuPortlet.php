<ul>
	...
	<?php if(Yii::app()->user->name == 'panitia'){ ?>
		...
		<?php if($cpengadaan->status == 'Penunjukan panitia') { ?>
			...
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Metode Penawaran',array('site/checkpoint2')); ?></b></li>
		<?php } ?>
		<?php if($cpengadaan->jenis_kualifikasi=='Pra Kualifikasi') { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Undangan Prakualifikasi',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->jenis_kualifikasi=='Pra Kualifikasi') { ?>
				<?php if($cpengadaan->status == 'Penunjukan panitia') { ?>
					<li><?php echo CHtml::link('Undangan Prakualifikasi',array('site/checkpoint2')); ?></li>
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Evaluasi Prakualifikasi',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->status == 'Penunjukan panitia') { ?>
				<li><?php echo CHtml::link('Undangan Pengambilan Dokumen Pengadaan',array('site/checkpoint4')); ?></li>
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Undangan Pengambilan Dokumen Pengadaan',array('site/checkpoint4')); ?></b></li>
		<?php } ?>
		<?php if($cpengadaan->status == 'Penunjukan panitia') { ?>
				<li><?php echo CHtml::link('Undangan Annwijzing',array('site/checkpoint4')); ?></li>
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Undangan Aanwijzing',array('site/checkpoint4')); ?></b></li>
		<?php } ?>
		<?php if($cpengadaan->status == 'Penunjukan panitia') { ?>
				<li><?php echo CHtml::link('Undangan Annwijzing',array('site/checkpoint4')); ?></li>
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Berita Acara Aanwijzing',array('site/checkpoint4')); ?></b></li>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Satu sampul') { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Undangan Pembukaan Penawaran',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Satu sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Pembukaan Penawaran',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Satu sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Evaluasi Penawaran',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua sampul') { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Undangan Pembukaan Penawaran Sampul Satu',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Pembukaan Penawaran Sampul Satu',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Evaluasi Penawaran Sampul Satu',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Undangan Pembukaan Penawaran Sampul Dua',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Pembukaan Penawaran Sampul Dua',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua sampul') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Evaluasi Penawaran Sampul Dua',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua tahap') { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Undangan Pembukaan Penawaran Tahap Satu',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua tahap') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Pembukaan Penawaran Tahap Satu',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua tahap') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Evaluasi Penawaran Tahap Satu',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua tahap') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Undangan Pembukaan Penawaran Tahap Dua',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua tahap') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Pembukaan Penawaran Tahap Dua',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if($cpengadaan->metode_penawaran=='Dua tahap') { ?>
				<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing')) { ?>
				...
				<?php } else { ?>
					<li><b><?php echo CHtml::link('Berita Acara Evaluasi Penawaran Tahap Dua',array('site/checkpoint2')); ?></b></li>
				<?php } ?>
		<?php } ?>
		<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing') || ($cpengadaan->status == 'Penawaran')) { ?>
			...
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Undangan Negosiasi dan Klarifikasi',array('site/checkpoint8')); ?></b></li>
		<?php } ?>
		<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing') || ($cpengadaan->status == 'Penawaran')) { ?>
				<li><?php echo CHtml::link('Berita Acara Negosiasi dan Klarifikasi',array('site/checkpoint8')); ?></li>
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Berita Acara Negosiasi dan Klarifikasi',array('site/checkpoint8')); ?></b></li>
		<?php } ?>
		<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing') || ($cpengadaan->status == 'Penawaran') || ($cpengadaan->status == 'Negosiasi dan Klarifikasi')) { ?>
			...
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Nota Dinas Usulan Pemenang',array('site/checkpoint8')); ?></b></li>
		<?php } ?>
		<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing') || ($cpengadaan->status == 'Penawaran') || ($cpengadaan->status == 'Negosiasi dan Klarifikasi') || ($cpengadaan->status == 'Usulan Pemenang') || ($cpengadaan->status == 'Penetapan Pemenang')) { ?>
			...
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Nota Dinas Pemberitahuan Pemenang',array('site/checkpoint8')); ?></b></li>
		<?php } ?>
		<?php if(($cpengadaan->status == 'Penunjukan panitia') || ($cpengadaan->status == 'Aanwijzing') || ($cpengadaan->status == 'Penawaran') || ($cpengadaan->status == 'Negosiasi dan Klarifikasi') || ($cpengadaan->status == 'Usulan Pemenang') || ($cpengadaan->status == 'Penetapan Pemenang') || ($cpengadaan->status == 'Penunjukan Pemenang')) { ?>
			...
			<?php } else { ?>
				<li><b><?php echo CHtml::link('Kontrak',array('site/checkpoint8')); ?></b></li>
		<?php } ?>

	...
	<?php if(Anggota::model()->exists('username = "' . Yii::app()->user->name . '"')){ ?>
		...
		<?php if ($cpengadaan->jenis_kualifikasi=="Pra Kualifikasi") { ?>
			...
			<?php } else if($cpengadaan->status == '3') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Dokumen Kualifikasi',array("site/dokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
			...
			<?php if($cpengadaan->metode_pengadaan=="Penunjukan Langsung"||$cpengadaan->metode_pengadaan=="Pemilihan Langsung") { ?>
				...
				<?php } else if($cpengadaan->status == '4') { ?>
					<li class='onprogress' ><?php echo CHtml::link('Undangan Prakualifikasi',array("site/suratundanganprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
				<?php } else { ?>
			...
			<?php } else if ($cpengadaan->metode_pengadaan=="Pelelangan") { ?>
				...
				<?php } else if($cpengadaan->status == '5') { ?>
					<li class='onprogress' ><?php echo CHtml::link('Pengumuman dan Pendaftaran',array("site/pengumumanpelelanganprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
				<?php } else if($cpengadaan->status == '6') { ?>
					<li class='onprogress' ><?php echo CHtml::link('Pengumuman dan Pendaftaran',array("site/pendaftaranpelelanganprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
				<?php } else if($cpengadaan->status == '7') { ?>
					<li class='onprogress' ><?php echo CHtml::link('Pengumuman dan Pendaftaran',array("site/pengambilandokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
				<?php } else { ?>
			...
			<?php } else if($cpengadaan->status == '8') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Penyampaian dan Evaluasi Kualifikasi',array("site/penyampaiandokumenprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '9') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Penyampaian dan Evaluasi Kualifikasi',array("site/evaluasiprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
			...
			<?php } else if($cpengadaan->status == '10') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Usulan dan Penetapan Hasil Kualifikasi',array("site/penetapanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else if($cpengadaan->status == '11') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Usulan dan Penetapan Hasil Kualifikasi',array("site/pengumumanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
			...
			<?php } else if($cpengadaan->status == '12') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Pengumuman Hasil Kualifikasi',array("site/pengumumanhasilprakualifikasi","id"=>"$cpengadaan->id_pengadaan")); ?></li>
			<?php } else { ?>
		...
		<?php if ($cpengadaan->jenis_kualifikasi=="Pasca Kualifikasi") { ?>
			...
			<?php } else if ($cpengadaan->metode_pengadaan=='Penunjukan Langsung'||$cpengadaan->metode_pengadaan=='Pemilihan Langsung'){ ?>
				...
				<?php } else if($cpengadaan->status == '13') { ?>
					<li class='onprogress' > <?php echo CHtml::link('Undangan Permintaan Penawaran',array("site/permintaanpenawaranharga","id"=>"$cpengadaan->id_pengadaan")); ?></li>
				<?php } else { ?>
		...
		<?php if($cpengadaan->metode_pengadaan=='Pelelangan'){ ?>
			...
			<?php } else if($cpengadaan->status == '16') { ?>
				<li class='onprogress' ><?php echo CHtml::link('Pengambilan Dokumen Pengadaan',array("site/pengambilandokumen","id"=>"$cpengadaan->id_pengadaan")); ?></li>	
			<?php } else { ?>
		...
		<?php if($cpengadaan->status == '0'||$cpengadaan->status == '1'||$cpengadaan->status == '2'||$cpengadaan->status == '3'||$cpengadaan->status == '4'||$cpengadaan->status == '5'||$cpengadaan->status == '6'||$cpengadaan->status == '7'||$cpengadaan->status == '8'||$cpengadaan->status == '9'||$cpengadaan->status == '10'||$cpengadaan->status == '11'||$cpengadaan->status == '12'||$cpengadaan->status == '13'||$cpengadaan->status == '14'||$cpengadaan->status == '15'||$cpengadaan->status == '16'||$cpengadaan->status == '17'||$cpengadaan->status == '18'||$cpengadaan->status == '19'||$cpengadaan->status == '20'||$cpengadaan->status == '21'||$cpengadaan->status == '22') { ?>
			...
			<?php } else if($cpengadaan->status == '26') { ?>
				<li class='onprogress'><?php echo CHtml::link('Penentuan Pemenang',array("site/suratpengumumanpemenang","id"=>"$cpengadaan->id_pengadaan")); ?></li>
